...
public:
	...
	UPROPERTY(EditAnywhere) TArray<UCxxRailSegment*> railSegments;
	...
	UPROPERTY(EditAnywhere) float bizerTangentIntensity = 150;
	...
	// 线路编辑
	void AddStation(ACxxStation* station, int idx, bool bIsArrowDir);
...
public:	
	...
	void UpdateRailLine();
	void UpdateRailLineSegment(UCxxRailSegment* seg, FVector mouseLocation);
